...
public class DomainPortImpl {
    ...
    public Long webtoonEnroll(@RequestBody RequestWebtoon webtoon, MultipartFile main, MultipartFile thumbnail) throws IOException {
        ...
        BlobInfo blobInfo1 = BlobInfo.newBuilder(blobId1).setContentType(main.getContentType()).build();
        ...
        BlobInfo blobInfo2 = BlobInfo.newBuilder(blobId2).setContentType(thumbnail.getContentType()).build();
